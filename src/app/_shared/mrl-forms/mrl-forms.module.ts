...
@NgModule({
  ...
  declarations: [ControlInputComponent, ControlCheckComponent, ControlTextareaComponent],
  exports: [ReactiveFormsModule, ControlCheckComponent, ControlInputComponent, ControlTextareaComponent]
})
